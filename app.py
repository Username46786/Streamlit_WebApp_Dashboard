...
DATA_URL = ("/Users/jcont/Documents/InteractiveDashboard_Streamlit/Tweets.csv")
...
select = st.sidebar.selectbox('Visualtion type', ['Histogram', 'Pie chart'], key='2')
...
word_sentiment = st.sidebar.radio('Display word cloud for what sentiment?', ('positive', 'neutral', 'neutral', 'negative'))
